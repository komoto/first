...
var dataSet2 = [90, 77, 55, 48, 64, 90, 85, 42, 13, 40];	// データセット2
var dataSet3 = [50, 27, 45, 58, 84, 70, 45, 22, 30, 90];	// データセット3
var margin = svgWidth /(dataSet1.length - 1);	// 折れ線グラフの間隔を算出
drawGraph(dataSet1, "itemA");	// itemAの折れ線グラフを表示
drawGraph(dataSet2, "itemB");	// itemBの折れ線グラフを表示
drawGraph(dataSet3, "itemC");	// itemBの折れ線グラフを表示
drawScale();	// 目盛りを表示
// 折れ線グラフを表示するための関数
